...
Para asignar que pin de la FPGA corresponde a que entrada y salida del modulo de Verilog, se debe ir al 'Device Constraint Editor'.
 ...
 \begin{figure}[H]
 \centering
 \subfloat{\includegraphics[height=12cm,width=0.5\textwidth]{Imagenes/SidePins.png}\label{fig:f1}}
 \subfloat{\includegraphics[height=10cm, width=0.5\textwidth]{Imagenes/FrontPins.png}\label{fig:f2}}
	\end{figure}
